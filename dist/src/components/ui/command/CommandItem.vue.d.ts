...
declare const _default: __VLS_WithTemplateSlots<import('vue').DefineComponent<__VLS_TypePropsToRuntimeProps<ComboboxItemProps<import('node_modules/radix-vue/dist/Combobox/ComboboxRoot').AcceptableValue> & {
    class?: any;
