import { AlertDialogContentProps } from 'radix-vue';
...
declare const __VLS_component: import('vue').DefineComponent<AlertDialogContentProps & {
    class?: string;
...
}, string, import('vue').PublicProps, Readonly<AlertDialogContentProps & {
    class?: string;
}> & Readonly<{
