...
const zones = [
  ...
  { continental_us: true, offset: 'GMT-08:00', name: 'America/Los_Angeles' },
  { offset: 'GMT-07:00', name: 'America/Chihuahua' },
  { continental_us: true, offset: 'GMT-07:00', name: 'America/Denver' },
  { offset: 'GMT-06:00', name: 'America/Belize' },
  { offset: 'GMT-06:00', name: 'America/Cancun' },
  { continental_us: true, offset: 'GMT-06:00', name: 'America/Chicago' },
  { offset: 'GMT-06:00', name: 'Chile/EasterIsland' },
  { offset: 'GMT-05:00', name: 'America/Bogota' },
  { offset: 'GMT-05:00', name: 'America/Havana' },
  { continental_us: true, offset: 'GMT-05:00', name: 'America/New_York' },
...
const continentalUsZones = computed(() => {
  return zones.filter((z) => z.continental_us).reverse()
})
</script>

<template>
  <Select @update:open="handleOpen">
    <SelectTrigger>
      <SelectValue placeholder="Timezone" />
    </SelectTrigger>
    <SelectContent>
      <SelectGroup>
        <SelectItem v-for="value of continentalUsZones" :value="value.name" :key="value.name"
          >{{ value.name }} ({{ value.offset }})</SelectItem
        >
      </SelectGroup>
    </SelectContent>
  </Select>
